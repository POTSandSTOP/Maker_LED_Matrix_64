...
#include "Maker_LED_Matrix_64.h"           //We include Maker LED Matrix Display library.
Maker_LED_Matrix_64 led;                   //Maker LED Matrix display library constructor.
...
void loop() {
  ...
  //Clear all and display image of 32px x 9px at location 18,0 with brightness level of 120 of 255.
  led.brightness(128, 0);
  led.picture8Bit(flame, 32, 9, 18, 0, 120);
