...
int Maker_LED_Matrix_64::webPage(char* web, char* url, int port, int _ms, int _stp, int _rep) {
...
int Maker_LED_Matrix_64::webPageText(char* web, char* url, int port, char* txt, int _n) {  //This function grabs textz form web page and saves it in user defined string that is send as function argument.
